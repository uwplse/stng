...
void c_action_hollerith_literal_constant(Token_t *carg_0);
...
void c_action_do_term_action_stmt(Token_t *carg_0, Token_t *carg_1, Token_t *carg_2, Token_t *carg_3, Token_t *carg_4, ofp_bool carg_5);
...
void c_action_goto_stmt(Token_t *carg_0, Token_t *carg_1, Token_t *carg_2, Token_t *carg_3, Token_t *carg_4);
...
void c_action_rice_co_dereference_op(Token_t *carg_0, Token_t *carg_1);
