...
static const int LiteralConstant_int_literal_constant=
	LiteralConstantBase+0;
static const int LiteralConstant_real_literal_constant=
	LiteralConstantBase+1;
static const int LiteralConstant_complex_literal_constant=
	LiteralConstantBase+2;
static const int LiteralConstant_logical_literal_constant=
	LiteralConstantBase+3;
static const int LiteralConstant_char_literal_constant=
	LiteralConstantBase+4;
static const int LiteralConstant_boz_literal_constant=
...
static const int IntrinsicTypeSpec_INTEGER=
	IntrinsicTypeSpecBase+0;
static const int IntrinsicTypeSpec_REAL=
	IntrinsicTypeSpecBase+1;
static const int IntrinsicTypeSpec_DOUBLEPRECISION=
	IntrinsicTypeSpecBase+2;
static const int IntrinsicTypeSpec_DOUBLECOMPLEX=
	IntrinsicTypeSpecBase+3;
static const int IntrinsicTypeSpec_COMPLEX=
	IntrinsicTypeSpecBase+4;
static const int IntrinsicTypeSpec_CHARACTER=
	IntrinsicTypeSpecBase+5;
static const int IntrinsicTypeSpec_LOGICAL=
	IntrinsicTypeSpecBase+6;
	static const int IntrinsicTypeSpec_TEAM=
			IntrinsicTypeSpecBase+7;
	static const int IntrinsicTypeSpec_CRAYPOINTER=
			IntrinsicTypeSpecBase+8;
	static const int IntrinsicTypeSpec_EVENT=
			IntrinsicTypeSpecBase+9;
	static const int IntrinsicTypeSpec_TOPOLOGY=
			IntrinsicTypeSpecBase+10;
	static const int IntrinsicTypeSpec_LOCK=
			IntrinsicTypeSpecBase+11;
	static const int IntrinsicTypeSpec_LOCKSET=
			IntrinsicTypeSpecBase+12;

static const int DeclarationTypeSpec_INTRINSIC=
	DeclarationTypeSpecBase+0;
static const int DeclarationTypeSpec_TYPE=
	DeclarationTypeSpecBase+1;
static const int DeclarationTypeSpec_CLASS=
	DeclarationTypeSpecBase+2;
static const int DeclarationTypeSpec_unlimited=
...
static const int ArraySpecElement_expr=
	ArraySpecElementBase+0;
static const int ArraySpecElement_expr_colon=
	ArraySpecElementBase+1;
static const int ArraySpecElement_expr_colon_expr=
	ArraySpecElementBase+2;
static const int ArraySpecElement_expr_colon_asterisk=
	ArraySpecElementBase+3;
static const int ArraySpecElement_asterisk=
	ArraySpecElementBase+4;
static const int ArraySpecElement_colon=
...
static const int BindingStatementType_specific=
	BindingStatementTypeBase+0;
static const int BindingStatementType_generic=
	BindingStatementTypeBase+1;
static const int BindingStatementType_const=
...
static const int TypeParamOrCompDef_typeParam= 
	TypeParamOrCompDefBase+0;
static const int TypeParamOrCompDef_compDef=
...
static const int ComponentAttrSpec_access_spec=
	ComponentAttrSpecBase+0;
static const int ComponentAttrSpec_allocatable=
	ComponentAttrSpecBase+1;
static const int ComponentAttrSpec_codimension=
	ComponentAttrSpecBase+2;
static const int ComponentAttrSpec_contiguous=
	ComponentAttrSpecBase+3;
static const int ComponentAttrSpec_dimension=
	ComponentAttrSpecBase+4;
static const int ComponentAttrSpec_pointer=
	ComponentAttrSpecBase+5;
static const int ComponentAttrSpec_kind=
	ComponentAttrSpecBase+6;
static const int ComponentAttrSpec_len=
	ComponentAttrSpecBase+7;

static const int ProcComponentAttrSpec_pointer=
	ProcComponentAttrSpecBase+0;
static const int ProcComponentAttrSpec_pass=
	ProcComponentAttrSpecBase+1;
static const int ProcComponentAttrSpec_nopass=
	ProcComponentAttrSpecBase+2;
static const int ProcComponentAttrSpec_access_spec=
	ProcComponentAttrSpecBase+3;

static const int GenericSpec_generic_name=
	GenericSpecBase+0;
static const int GenericSpec_OPERATOR=
	GenericSpecBase+1;
static const int GenericSpec_ASSIGNMENT=
	GenericSpecBase+2;
static const int GenericSpec_dtio_generic_spec=
	GenericSpecBase+3;

static const int DTIOGenericSpec_READ_FORMATTED=
	DTIOGenericSpecBase+0;
static const int DTIOGenericSpec_READ_UNFORMATTED=
	DTIOGenericSpecBase+1;
static const int DTIOGenericSpec_WRITE_FORMATTED=
	DTIOGenericSpecBase+2;
static const int DTIOGenericSpec_WRITE_UNFORMATTED=
